...
class EditGroceryIngredient extends ConsumerStatefulWidget {
  const EditGroceryIngredient({super.key, required this.ingredient});
  final Ingredient ingredient;
  @override
  ConsumerState<EditGroceryIngredient> createState() =>
      _EditGroceryIngredientState();
}

class _EditGroceryIngredientState extends ConsumerState<EditGroceryIngredient> {
